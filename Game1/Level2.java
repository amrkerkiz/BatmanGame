...
public class Level2 extends Stage
{
    ...
    public Level2(int lives, int score)
    {
        //showBounds(true);
        ...
        addActor(thugMaker(1), 910, 300);
        addActor(thugMaker(1), 1000, 300);
        addActor(thugMaker(1), 1000, 300);
        
        addActor(thugMaker(2), 1100, 300);
        addActor(thugMaker(2), 1200, 300);
        addActor(thugMaker(2), 1300, 300);
        
        addActor(thugMaker(3), 1400, 300);
        addActor(thugMaker(3), 1500, 300);
        addActor(thugMaker(3), 1600, 300);
    ...
    public void update() {
        ...
        for(Actor a : bats.getTouching()) {
            ...
            if (a instanceof Batmobile) {
                ...
                getMayflower().setStage(new Cutscene3(bats.getLives(), bats.getScore()));
            }
        }
